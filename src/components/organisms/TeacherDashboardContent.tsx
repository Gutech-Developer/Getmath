    ...
    return (
      <div className="w-full flex flex-col gap-6 md:gap-8">
            ...
            action={
              onCreateClass && (
                <button
                  ...
                  className="bg-lottie-teal hover:bg-lottie-teal/90 duration-200 text-white font-semibold flex items-center gap-2 px-4 py-3 rounded-xl text-sm font-semibold"
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Materi Terbaru */}
          <section className="getmath-card p-5 md:p-6 flex flex-col gap-4">
            <SectionHeader
            ...
            <div className="flex flex-col divide-y divide-grey-stroke">
              {recentMaterials.length > 0 ? (
                recentMaterials.map((item) => (
                  ...
                  >
                    <div className="w-9 h-9 rounded-xl bg-lottie-teal/5 text-lottie-teal flex items-center justify-center shrink-0">
                      {item.icon}
                    </div>
